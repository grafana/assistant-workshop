...
const config = {
  title: 'Introduction to Grafana Assistant Workshop',
  tagline: 'Assistant is cool',
  ...
  baseUrl: '/assistant-workshop/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'grafana', // Usually your GitHub org/user name.
  projectName: 'assistant-workshop', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/grafana/assistant-workshop/tree/main/site/',
          admonitions: {
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'Introduction to Grafana Assistant Workshop - Grafana Labs',
        logo: {
          alt: 'My Site Logo',
          src: 'img/grafana.svg',
        },
        items: [
          {
            href: 'https://github.com/grafana/assistant-workshop',
            label: 'GitHub',
            position: 'right',
          },
        ],
